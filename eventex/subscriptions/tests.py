...
class Subscribe(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Andre Bernardi', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('andre.bernardi@fm.usp.br', email.body)
        self.assertIn('11-95343-5443', email.body)
...
class SuscribeSuccessMessage(TestCase):
